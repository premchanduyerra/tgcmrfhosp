        ...
        <div className='row px-1 py-3' style={{backgroundColor:'#545454'}}>
            <div className='col-md-5 text-start'>
                ...
                <p>Best viewed with Internet Explorer IE 9+
                 <img src="assets/header-images/ieimage.png" style={{width:'20px'}} alt='Inter Explorer'/>
                 Firefox 61+ <img src="assets/header-images/firefoximg.jpg" alt='Firefox' style={{width:'20px'}}/>
                 Chrome 70+ <img src="assets/header-images/chromeimg.jpg" alt='chrome' style={{width:'20px'}}/></p>
            </div>
